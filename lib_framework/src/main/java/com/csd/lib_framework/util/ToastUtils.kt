package com.csd.lib_framework.util
...
import com.csd.lib_framework.R
import com.csd.lib_framework.databinding.FrameworkLayoutToastBinding
import com.csd.lib_framework.ext.dp
import com.csd.lib_framework.ext.res.tint
import com.csd.lib_framework.util.ToastUtils.Location
import com.csd.lib_framework.util.ToastUtils.error
import com.csd.lib_framework.util.ToastUtils.success
import com.csd.lib_framework.util.ToastUtils.warn
...
object ToastUtils {
    ...
    private fun toastImpl(
        ...
        // 不是主线程使用会报错： java.lang.NoClassDefFoundError: com.csd.lib_framework.util.ToastUtils
        // 需要下面的判断
