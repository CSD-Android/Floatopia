package com.csd.lib_framework.widget
 ...
 */
class OffsetAppBarLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = R.attr.appBarLayoutStyle
) : AppBarLayout(context, attrs, defStyleAttr) {
    companion object {
        private val TAG = OffsetAppBarLayout::class.simpleName
    }
    ...
    init {
        ...
        addOnOffsetChangedListener { appBarLayout: AppBarLayout, verticalOffset: Int ->
            ...
            if (changed) {
                listeners?.forEach {
                    it.onStateChange(this@OffsetAppBarLayout, currentState)
                }
            }
        }
